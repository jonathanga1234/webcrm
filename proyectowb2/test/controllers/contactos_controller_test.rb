...
class ContactosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post contactos_url, params: { contacto: { apellidos: @contacto.apellidos, cliente: @contacto.cliente, correo: @contacto.correo, nombre: @contacto.nombre, numero: @contacto.numero, puesto: @contacto.puesto } }
    end
  ...
  test "should update contacto" do
    patch contacto_url(@contacto), params: { contacto: { apellidos: @contacto.apellidos, cliente: @contacto.cliente, correo: @contacto.correo, nombre: @contacto.nombre, numero: @contacto.numero, puesto: @contacto.puesto } }
